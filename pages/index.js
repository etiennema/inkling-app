...
if (screen === 'landing') {
    return (
      <div style={{ 
        ...
        >
          {/* Tracing the actual reference - big organic blobs and dramatic curves */}
          <path
            d="M 50 170 C 45 155, 42 140, 45 125 C 48 110, 55 95, 65 85 C 75 75, 90 70, 105 68 C 120 66, 135 67, 150 68 C 180 70, 210 71, 240 70 C 270 69, 300 68, 330 69 C 345 70, 360 73, 370 82 C 380 91, 385 105, 383 120 C 381 135, 375 150, 378 165 C 381 180, 388 195, 387 210 C 386 225, 380 240, 382 255 C 384 270, 390 285, 388 300 C 386 315, 378 330, 380 345 C 382 360, 388 375, 386 390 C 384 405, 376 420, 378 435 C 380 450, 387 465, 383 480 C 379 495, 368 508, 355 515 C 342 522, 325 525, 308 526 C 275 528, 242 527, 209 526 C 176 525, 143 526, 110 527 C 93 528, 76 528, 60 525 C 52 523, 44 519, 40 512 C 36 505, 35 495, 36 485 C 37 460, 42 435, 40 410 C 38 385, 32 360, 35 335 C 38 310, 46 285, 43 260 C 40 235, 32 210, 38 185 C 44 160, 48 175, 50 170 Z"
            fill="none"
            stroke="#000000"
            strokeWidth="3"
            strokeLinecap="round"
