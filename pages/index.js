...
if (screen === 'landing') {
    ...
    <div style={{ 
      ...
      bottom: 0 
        ...
        style={{
          ...
          right: '10px',
          bottom: '10px',
          backgroundImage: `url('/squiggle.svg')`,
  ...
  if (screen === 'congrats') {
  // Check if this is the 50th drawing
  const isMilestone = submissionCount === 50;
  
  return (
    <div 
      onClick={() => !isMilestone && setScreen('gallery')}
      style={{ 
        height: '100vh',
        minHeight: '-webkit-fill-available',
        backgroundColor: '#F8F6F2', 
    ...
    >
      ...
      <h1 style={{ fontSize: 'clamp(48px, 10vw, 72px)', fontWeight: 'bold', margin: '0 0 40px 0', textAlign: 'center' }}>
        {isMilestone ? "YOU'VE COMPLETED 50 DRAWINGS! 🎉" : "CONGRATS!"}
      </h1>
      
      <div style={{ marginBottom: '30px', maxWidth: '400px', width: '100%', aspectRatio: '1/1' }}>
        {lastSubmittedImage && (
          <img
      ...
      {!isMilestone ? (
        <p style={{ fontSize: 'clamp(18px, 4vw, 24px)', textAlign: 'center', margin: '0 0 40px 0', lineHeight: '1.4' }}>
          YOU'VE COMPLETED<br />
        ...
        <div style={{ width: '100%', maxWidth: '400px', textAlign: 'center' }}>
          {!emailSubmitted ? (
            <>
              <p style={{ fontSize: 'clamp(18px, 4vw, 24px)', margin: '0 0 24px 0', lineHeight: '1.4' }}>
                ENTER YOUR EMAIL FOR A LIL SURPRISE:
              </p>
              <input
                type="email"
                value={milestoneEmail}
                onChange={(e) => setMilestoneEmail(e.target.value)}
              ...
              <button
                onClick={async () => {
                  if (!milestoneEmail || !milestoneEmail.includes('@')) {
            ...
            <p style={{ fontSize: 'clamp(18px, 4vw, 24px)', margin: '0 0 40px 0', lineHeight: '1.4' }}>
              ✨ THANK YOU! ✨<br />
    ...
    return (
      <div style={{ minHeight: '100vh', backgroundColor: '#F8F6F2', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px', fontFamily: 'Helvetica, Arial, sans-serif' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ marginBottom: '32px' }}>COME BACK TOMORROW FOR A NEW PROMPT!</p>
...
return (
  <div style={{ height: '100vh', backgroundColor: '#F8F6F2', fontFamily: 'Helvetica, Arial, sans-serif', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
    ...
    <div style={{ padding: '40px 20px 20px', flexShrink: 0 }}>
        ...
        Scroll around to see the <strong>{gallery.length - 1}</strong> other drawing{gallery.length - 1 !== 1 ? 's' : ''} submitted today!
        </p>
      </div>
